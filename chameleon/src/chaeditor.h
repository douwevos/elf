...
struct _ChaEditorClass {
	...
	void (*controlLocation)(ChaEditor *editor, ChaCursorWo *cursor, gboolean clicked);
	ChaUow *(*createInsertOrReplaceUow)(ChaEditor *editor, ChaEditMode mode, CatStringWo *text);
};
