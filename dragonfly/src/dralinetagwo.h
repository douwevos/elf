...
enum _DraTagType {
	DRA_TAG_TYPE_MODEL,
	DRA_TAG_TYPE_PARSER,
	DRA_TAG_TYPE_SCANNER,
	DRA_TAG_TYPE_SPELL
};

typedef enum _DraTagLevel DraTagLevel;

enum _DraTagLevel {
	DRA_TAG_LEVEL_ERROR,
	DRA_TAG_LEVEL_WARN,
	DRA_TAG_LEVEL_UNSAFE,
	DRA_TAG_LEVEL_INFO,
	DRA_TAG_LEVEL_MARK
};
...
DraLineTagWo *dra_line_tag_wo_new(long long row, DraTagType tag_type, DraTagLevel level);
