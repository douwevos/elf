...
typedef struct _DraControlLeftRight DraControlLeftRight;

struct _DraControlLeftRight {
	int left;
	int right;
};
...
struct _DraContextEditorClass {
	...
	void (*openDeclaration)(DraContextEditor *context_editor, ChaCursorWo *cursor);
	DraControlLeftRight (*calculateControlLeftRight)(DraContextEditor *context_editor, ChaLineWo *line, ChaCursorWo *cursor);
	void (*contextInsertText)(DraContextEditor *context_editor, CatStringWo *text);
};
...
DraControlLeftRight dra_context_editor_calculate_control_left_right(DraContextEditor *context_editor, ChaLineWo *line, ChaCursorWo *cursor);
